...
public class updateEmpSalaryWindow extends JFrame {
    ...
    public updateEmpSalaryWindow() {
        ...
        continueButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                recordSystem.updateEmployeeSalary(Integer.parseInt(empID.getText()));
            }
        });
    ...
    public void BuildComponents() {
        ...
        continueButton = new JButton("Update Salary");
        ...
        continueButton.setBounds(120, 200, 170, 40);
