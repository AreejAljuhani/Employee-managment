...
public class showDetailsEmpWindow extends JFrame {
    ...
    public showDetailsEmpWindow() {
        ...
        continueButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                recordSystem.showEmployeeDetails(Integer.parseInt(empID.getText()));
            }
        });
    ...
    public void BuildComponents() {
        ...
        continueButton = new JButton("Show");
